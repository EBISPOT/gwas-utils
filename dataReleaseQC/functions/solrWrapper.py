...
class solrWrapper(object):
    ...
    def isCoreOK(self):
        ...
        print('[Info] Core ({}) is up and running.'.format(self.__core))
    ...
    def getResourceCounts(self,resouce):
    ...
    def wipeCore(self):
        ...
        print('[Info] Number of documents in the {} core: {}'.format(self.__core,self.getAllDocumentCount()))
        return(0)
    ...
    def query(self, term = None, keyword_terms = None, rows = None, 
